...
the article-template:
  ...
  <script src="//cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-HTML"></script>
  <!-- Original script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script-->
  <script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
  <!-- New script src="//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script-->
